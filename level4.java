...
public class level4 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
                ...
                if ((i == 1 && j == 1 || (i == 2 && j == 1) || (i == 3 && j == 1)
                	...
                	||(i == 7 && j == 1) || (i == 8 && j == 1) || (i == 1 && j == 2)
                	||(i == 2 && j == 2) || (i == 3 && j == 2) || (i == 4 && j == 2)
                	||(i == 5 && j == 2) || (i == 6 && j == 2) || (i == 7 && j == 2)
                	||(i == 8 && j == 2) || (i == 1 && j == 3) || (i == 2 && j == 3)
                	||(i == 3 && j == 3) || (i == 4 && j == 3) || (i == 5 && j == 3)
                	||(i == 6 && j == 3) || (i == 7 && j == 3) || (i == 8 && j == 3)
                	||(i == 1 && j == 4) || (i == 2 && j == 4) || (i == 3 && j == 4)
                	||(i == 4 && j == 4) || (i == 5 && j == 4) || (i == 6 && j == 4)
                	||(i == 7 && j == 4) || (i == 8 && j == 4)) )
                    gridPane.add(mirror,i,j);
                else if ((i == 1 && j == 5 || (i == 2 && j == 5) || (i == 3 && j == 5)
                    	||(i == 4 && j == 5) || (i == 5 && j == 5) || (i == 6 && j == 5)
                    	||(i == 7 && j == 5) || (i == 8 && j == 5) || (i == 1 && j == 6)
                    	||(i == 2 && j == 6) || (i == 3 && j == 6) || (i == 4 && j == 6)
                    	||(i == 5 && j == 6) || (i == 6 && j == 6) || (i == 7 && j == 6)
                    	||(i == 8 && j == 6) || (i == 1 && j == 7) || (i == 2 && j == 7)
                    	||(i == 3 && j == 7) || (i == 4 && j == 7) || (i == 5 && j == 7)
                    	||(i == 6 && j == 7) || (i == 7 && j == 7) || (i == 8 && j == 7)
                    	||(i == 1 && j == 8) || (i == 2 && j == 8) || (i == 3 && j == 8)
                    	||(i == 4 && j == 8) || (i == 5 && j == 8) || (i == 6 && j == 8)
                    	||(i == 7 && j == 8) || (i == 8 && j == 8) ))
        ...
        lvl5.start(level5.classStage);
        Stage stage = (Stage) next.getScene().getWindow();
        stage.close();
        });
        pane.setBottom(next);
        pane.setTop(new Text("Level 4"));
