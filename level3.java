...
public class level3 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        lvl4.start(level4.classStage);
        Stage stage = (Stage) next.getScene().getWindow();
        stage.close();
        });
        pane.setBottom(next);
        pane.setTop(new Text("Level 3"));
